...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      id: '1	睡觉	olURh5-sl63biyE_GsjzcsuowSKs',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      useTemplateId: '1	睡觉	olURh5-sl63biyE_GsjzcsuowSKs',
  ...
  CALLBACK_TEMPLATE_ID: '1	睡觉	olURh5-sl63biyE_GsjzcsuowSKs',

  CALLBACK_USERS: [
    {
      name: 'olURh5yZ0Q7trx8hlbd5UOpFSsl4',
